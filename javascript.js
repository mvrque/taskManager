...
function addTask() {
    ...
    if(document.querySelector("#taskResultHeading1").innerHTML === ""  && document.querySelector("#taskResultDate1").innerHTML === ""){
    ...
    }else if(document.querySelector("#taskResultHeading2").innerHTML === ""  && document.querySelector("#taskResultDate2").innerHTML === ""){
    ...
    }else if(document.querySelector("#taskResultHeading3").innerHTML === ""  && document.querySelector("#taskResultDate3").innerHTML === ""){
    ...
    else if(document.querySelector("#taskResultHeading4").innerHTML === ""  && document.querySelector("#taskResultDate4").innerHTML === ""){
    ...
    }else if(document.querySelector("#taskResultHeading5").innerHTML === ""  && document.querySelector("#taskResultDate5").innerHTML === ""){
